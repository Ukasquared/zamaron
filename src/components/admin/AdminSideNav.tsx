const navItems = [
  ...
  { id: "users", label: "User Management", icon: "group", active: true, fill: true },
      ...
      >
        <div className="p-6 md:p-8 flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded bg-cyan-500/20 flex items-center justify-center border border-cyan-400/50 shrink-0">
              <span
        ...
        <div className="p-6 mt-auto border-t border-white/5">
          <button className="flex items-center gap-3 px-6 py-4 text-slate-400 font-medium hover:bg-white/5 hover:text-cyan-200 transition-all duration-300 ease-out w-full rounded-lg">
