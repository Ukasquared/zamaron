...
export const ALL_PAGE_CATALOG: PageEntry[] = [
  ...
  },
  {
    ...
    sourceFile: 'admin-operations-overview.html',
    route: '/admin/overview',
    domain: 'Admin Operations',
    description: 'Operative registry, protocol risk heatmap, and security activity stream.',
  },
  {
    title: 'Security Operations Monitor',
    sourceFile: 'security-operations-monitor.html',
    route: '/admin/security-monitor',
    domain: 'Admin Operations',
    description: 'Forensic administrative surveillance and live authorization telemetry.',
  },
  {
    title: 'Academy Course Library',
    sourceFile: 'academy-course-library.html',
    route: '/courses',
    domain: 'Academy',
    description: 'Searchable course catalog with filters, featured learning, and progress tracking.',
  },
  {
    title: 'Performance Analytics',
    sourceFile: 'performance-analytics.html',
    route: '/analytics',
    domain: 'Auditor Workspace',
    description: 'Operator proficiency, skill distribution, KPIs, and assessment history.',
  },
  {
    title: 'Neural Contract Scanner',
    sourceFile: 'neural-contract-scanner.html',
    route: '/scanner',
    domain: 'Auditor Workspace',
    description: 'Heuristic contract scanning, risk clusters, audit history, and threat feed.',
  },
  {
    title: 'Neural Risk Assessment',
    sourceFile: 'neural-risk-assessment.html',
    route: '/risk-report',
    domain: 'Client Portal',
    description: 'Neural risk scoring, threat vectors, and AI-assisted audit analysis.',
  },
  {
    title: 'Scam Detector Intelligence',
    sourceFile: 'scam-detector-intelligence.html',
    route: '/threat-hub/scam-detector',
    domain: 'Intelligence & Threat Hub',
    description: 'Contract and domain scan intake with threat feed, network health, and scan history.',
  },
];
